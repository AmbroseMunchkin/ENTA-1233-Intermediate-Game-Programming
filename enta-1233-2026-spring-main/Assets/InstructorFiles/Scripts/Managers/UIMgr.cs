...
public class UIMgr : Singleton<UIMgr> 
{
    ...
    [SerializeField] private MenuBase _gameLevelCompleteMenuPrefab;
    [SerializeField] private MenuBase _selectLevelMenuPrefab;
    ...
    private MenuBase GetMenuPrefabFromType(GameMenus menuType)
    {
        ...
        switch (menuType)
        {
            ...
            case GameMenus.LevelCompleteMenu:
                menu = _gameLevelCompleteMenuPrefab;
                break;
            case GameMenus.LevelSelectMenu:
                menu = _selectLevelMenuPrefab;
                break;
            default:
